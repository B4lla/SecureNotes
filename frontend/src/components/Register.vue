    ...
    <div class="max-w-md w-full relative z-10">
      ...
      <div class="bg-gray-900/70 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-800 p-8 relative">
        ...
        <form @submit.prevent="handleRegister" class="space-y-5">
          ...
          <div v-if="success" class="bg-green-500/10 border border-green-800 rounded-xl p-4 text-green-400 text-sm flex items-start space-x-3">
  ...
  methods: {
    async handleRegister() {
      ...
      if (this.username.length < 3) {
        this.error = 'User must have at least 3 characters';
        return;
      }
